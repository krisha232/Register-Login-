...
firebase =firebase.FirebaseApplication("https://registeration-2a109-default-rtdb.firebaseio.com/",None)
...
def register(): 
    ...
    hexdigest_var=encrypt_password.hexdigest()
    print(hexdigest_var)
    firebase.put("/",username,hexdigest_var)
    messagebox.showinfo("hi","User Is Registered")
